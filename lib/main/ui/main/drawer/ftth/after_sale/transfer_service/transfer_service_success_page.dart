...
class TransferServiceSuccessPage extends GetView<TransferServiceSuccessLogic> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: TransferServiceSuccessLogic(context: context),
        builder: (controller) {
          return Scaffold(
            body: Column(
              children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            inforContractRow(
                                lable:
                                    "${AppLocalizations.of(context)!.textCurrentInstallationAddress}:",
                                richText: () {
                                  return RichText(
                                      text: TextSpan(
                                    text:
                                        controller.model.getInstalAddressOld(),
                                    style: AppStyles.r415263_13_500,
                                  ));
                                }),
                            DottedLine(
                            ...
                            inforContractRow(
                                lable:
                                    "${AppLocalizations.of(context)!.textNewInstallationAddress}:",
                                richText: () {
                                  return RichText(
                                      text: TextSpan(
                                    text:
                                        controller.model.getInstalAddressNew(),
                                    style: AppStyles.r415263_13_500,
                                  ));
                                }),
                            DottedLine(
                            ...
                            inforContractRow(
                                lable:
                                    "${AppLocalizations.of(context)!.textDateOfTransfer}:",
                                richText: () {
                                  return Text(
