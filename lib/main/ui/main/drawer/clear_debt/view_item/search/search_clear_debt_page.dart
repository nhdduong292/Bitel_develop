                ...
                children: [
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      Container(
                        margin:
                            EdgeInsets.only(left: 22, right: 15, bottom: 14),
                        height: 45,
                        decoration: BoxDecoration(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border:
                              Border.all(color: Color(0xFFE3EAF2), width: 1),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: 20, right: 12.01),
                              child: InkWell(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                child:
                                    SvgPicture.asset(AppImages.icRefreshCapcha),
                              ),
                            )
                          ],
                        ),
