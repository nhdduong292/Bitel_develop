...
import 'package:bitel_ventas/main/ui/main/drawer/manage_contact/create_cusomter_with_dni/view_item/client_data/client_data_dni.dart';
import 'package:bitel_ventas/main/ui/main/drawer/manage_contact/create_cusomter_with_dni/view_item/document_scan/document_scanning_dni.dart';
...
import 'cretate_contact_with_dni_page_logic.dart';

class CreateContactDNIPage extends GetView<CreateContactPageDNILogic> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder(
        init: CreateContactPageDNILogic(),
        builder: (controller) {
          return Scaffold(
            body: Column(
              children: [
                ...
                Expanded(
                  child: ScrollablePositionedList.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == 0) {
                          return DocumentScanningDNIWidget(
                            callback: () {
