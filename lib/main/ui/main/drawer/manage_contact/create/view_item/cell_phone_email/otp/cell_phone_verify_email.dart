...
import 'cell_phone_verify_email_logic.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

typedef void TouchScan();

class CellPhoneVerifyEmailWidget extends GetView<CellPhoneVerifyEmailWidget> {
  final TouchScan callback;
  CellPhoneVerifyEmailWidget({required this.callback});
  @override
  Widget build(BuildContext context) {
    var width = MediaQuery.of(context).size.width;
    return GetBuilder(
        init: CellPhoneVerifyEmailLogic(),
        builder: (controller) {
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.textWehavesent,
