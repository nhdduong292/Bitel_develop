...
class ContractInformationWidget extends GetView<ContractInformationLogic> {
  final TouchUpadte callback;
  ContractInformationWidget({required this.callback});
  @override
  Widget build(BuildContext context) {
    var width = MediaQuery.of(context).size.width;
    return GetBuilder(
        init: ContractInformationLogic(),
        builder: (controller) {
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  lockedBox(
                      content: '1',
                      label:
                          AppLocalizations.of(context)!.textQuantitySubscriber,
                      required: true,
                      isIcon: false,
                      width: 210),
                  lockedBox(
                  ...
                  lockedBox(
                      content: 'Email',
                      label:
                          AppLocalizations.of(context)!.textChangeNotification,
                      required: false,
                      isIcon: true,
                      width: 210),
                  lockedBox(
                    ...
                    child: Center(
                      child: Text(
                        AppLocalizations.of(context)!
                            .textProtectionFilterAdvertising,
                        style: AppStyles.r00A5B1_15d5_500,
                      ),
                    ),
                  ),
