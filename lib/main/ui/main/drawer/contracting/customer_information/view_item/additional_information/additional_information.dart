...
class AdditionalInformationWidget extends GetView<AdditionalInformationLogic> {
  final TouchScan callback;
  AdditionalInformationWidget({required this.callback});
  @override
  Widget build(BuildContext context) {
    var width = MediaQuery.of(context).size.width;
    return GetBuilder(
        init: AdditionalInformationLogic(),
        builder: (controller) {
